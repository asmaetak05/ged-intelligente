...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans selection:bg-emerald-500 selection:text-white relative">
      {/* Texture Background */}
      ...
      {/* Header */}
      <header className="relative z-10 bg-white/80 backdrop-blur-md border-b border-zinc-200 sticky top-0">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-emerald-900 leading-tight">GED Intelligente</h1>
              <p className="text-xs font-medium text-emerald-700 tracking-wider uppercase">Plateforme Décisionnelle</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button 
      ...
      <section className="relative z-10 pt-24 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-100/50 border border-emerald-200 text-emerald-800 text-xs font-semibold mb-8 tracking-wide uppercase shadow-sm">
          ...
          <h2 className="text-5xl md:text-6xl font-extrabold text-zinc-900 tracking-tight leading-[1.1] mb-6">
          ...
          {/* Mockup Preview */}
          <div className="relative mx-auto max-w-4xl rounded-2xl border border-zinc-200/80 bg-white/50 backdrop-blur-sm p-2 shadow-2xl shadow-zinc-200/50 mt-12 overflow-hidden transform transition-transform hover:scale-[1.01] duration-500">
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-50 to-transparent z-10 pointer-events-none"></div>
            <img 
            ...
            <div className="absolute bottom-8 left-0 right-0 z-20 flex justify-center">
              <button 
                onClick={() => navigate('/dashboard')}
                className="bg-zinc-900 hover:bg-zinc-800 text-white px-8 py-3.5 rounded-full text-base font-medium transition-all shadow-xl shadow-zinc-900/20 flex items-center gap-2 hover:-translate-y-0.5"
              >
      ...
      <section className="relative z-10 py-20 bg-white border-y border-zinc-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-zinc-900 mb-4">Une couverture exhaustive du territoire</h3>
            <p className="text-zinc-500 max-w-2xl mx-auto">Notre moteur de collecte scrute le portail officiel pour récupérer l'intégralité de la donnée économique.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Organismes */}
            <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6">
                <Building2 size={24} />
              </div>
              <h4 className="text-xl font-semibold text-zinc-900 mb-4">Organismes Acheteurs</h4>
            ...
            <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h4 className="text-xl font-semibold text-zinc-900 mb-4">Domaines d'Activité</h4>
              <ul className="space-y-3">
            ...
            <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h4 className="text-xl font-semibold text-zinc-900 mb-4">Régions Couvertes</h4>
              <ul className="space-y-3">
